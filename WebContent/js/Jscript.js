...
$(document).on("click", "#td_myorders", function() {
	...
	$.ajax({
		...
		success : function(responseText) {
			...
			var orderTable="<b>Orders</b><br/><br/><table class='table' width='100%'><thead class='thead-dark'><tr class='tile'><th scope='col'><strong>Order No</strong></th><th scope="col"><strong>Product Name</strong></th><th scope='col'><strong>Price</strong></th><th scope="col"><strong>Date</strong></th><th scope='col'><strong>Quantity</strong></th><th scope='col'><strong>Amount</strong></th><th scope='col'><strong>status</strong></th></tr></thead>";
			for(var i=0;i<obj[0].data.length;i++)
			{
				if(obj[0].data[i].status!="Order Delivered"){
				if(i%2 == 0)
				{
					orderTable = orderTable + "<tbody><tr class='tile'><td>"+obj[0].data[i].orderid+"</td><td>"+obj[0].data[i].productname+"</td>" +
					"<td>"+obj[0].data[i].price+"</td><td>"+obj[0].data[i].orderdate+"</td><td>"+obj[0].data[i].productquantity+"</td><td>"+obj[0].data[i].totalamount+"</td><td>"+obj[0].data[i].status+"</td></tr></tbody>";
					}
				else
				{
					orderTable = orderTable + "<tbody><tr class='tile'><td>"+obj[0].data[i].orderid+"</td><td>"+obj[0].data[i].productname+"</td>" +
	...
	$.ajax({
		...
		success : function(responseText) {
			...
			//alert(obj[0].data.length);
			//alert(obj[0].data[0].productname);
			var orderTable="<b>Orders</b><br/><br/><table width='100%'><tr class='tile'><td><strong>Order No</strong></td><td><strong>Product Name</strong></td><td><strong>Price</strong></td><td><strong>Date</strong></td><td><strong>Quantity</strong></td><td><strong>Amount</strong></td><td><strong>status</strong></td><td></td>";
			for(var i=0;i<obj[0].data.length;i++)
			{
				...
				if(i%2 == 0)
				{
					...
					"<td>"+obj[0].data[i].price+"</td><td>"+obj[0].data[i].orderdate+"</td><td>"+obj[0].data[i].productquantity+"</td><td>"+obj[0].data[i].totalamount+"</td><td>"+obj[0].data[i].status+"</td><td><button type='button' id="+obj[0].data[i].orderid+" onclick='changestatus(this.id)'>changestatus</button></td></tr>";
					}
				else
				{
					orderTable = orderTable + "<tr class='tile'><td>"+obj[0].data[i].orderid+"</td><td>"+obj[0].data[i].productname+"</td>" +
...
function showuserinfo()
{
	...
	$.ajax({
		...
		success : function(responseText) {
			...
			if(obj[0].success[0].success == "success"){
				...
				var usertable="<table border='1' width='100%'><tr class='tbl_header'><td colspan='3' class='Bold1'><strong>User Info</strong></td><td colspan='1' class='Bold1'><strong><input type='button' id='btnChngPwd' value='Change Password' /></strong></td></tr><br/>";
	...
	$.ajax({
		...
		success : function(responseText) {
			...
			//alert(obj[0].data.length);
			//alert(obj[0].data[0].productname);
			var orderTable="<br/><br/><b>Order History</b><table width='100%'><br/><tr class='tile'><td><strong>Order No</strong></td><td><strong>Product Name</strong></td><td><strong>Price</strong></td><td><strong>Date</strong></td><td><strong>Quantity</strong></td><td><strong>Amount</strong></td><td><strong>status</strong></td>";
