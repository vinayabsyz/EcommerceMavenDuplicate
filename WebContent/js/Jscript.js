...
function showuserinfo()
{
	...
	$.ajax({
		...
		success : function(responseText) {
			...
			if(obj[0].success[0].success == "success"){
				...
				var usertable="<table border='1' width='100%'><tr class='tbl_header'><td colspan='1' class='Bold1'><strong><input type='button' id='btnChngPwd' value='Change Password' /></strong></td></tr><br/>";
	...
	$.ajax({
		...
		success : function(responseText) {
			...
			//alert(obj[0].data.length);
			//alert(obj[0].data[0].productname);
			var orderTable="<br/><br/><table width='100%'><br/><tr class='tile'><td><strong>Order No</strong></td><td><strong>Product Name</strong></td><td><strong>Price</strong></td><td><strong>Date</strong></td><td><strong>Quantity</strong></td><td><strong>Amount</strong></td><td><strong>status</strong></td>";
