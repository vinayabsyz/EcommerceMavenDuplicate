...
function loadProducts()
{
	...
	$.ajax({
		...
		success : function(responseText) {
			...
			//alert(obj[0].data.length);
			//alert(obj[0].data[0].productname);
			var productTable="<table><tr class='tile1' style='height:30px;'><td></td><td class='h1'>Brand</td><td  class='h1'>Product Name</td><td class='h1'> Price</td><td class='h1'>select</td></tr>";
			for(var i=0;i<obj[0].data.length;i++)
			{
